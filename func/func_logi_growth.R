...
# Add exponential curve for comparison

exp_vals <- 10 * exp(0.1 * seq(1, 100, 0.1))      # same r and time grid as ode()
lines(seq(1, 100, 0.1), exp_vals, col = "blue", lwd = 2)
